...
- **관리자 중심**: VRAM 제한(정책 준수 시 자동 종료) 및 감시 기능이 포함됨.
- **개발자 친화적**: GEMM, 입자 물리학 시뮬레이션과 같은 벤치마크 및 스트레스 테스트 도구를 내장.
...
- **벤치마크 및 시뮬레이션**:
  - **스트레스 테스트**: GEMM 워크로드를 사용하여 열 분산 및 시스템 안정성 테스트.
...
- **다중 GPU 지원**: NVLink 토폴로지를 포함한 다중 카드 및 다중 노드 설정을 향상.
